...
- [ ] **G1.1** Go 语言概述与设计哲学（诞生背景/核心设计理念/Go vs Python vs JS/适用场景）
- [ ] **G1.2** 环境搭建与工具链（安装/GOROOT/GOPATH/go mod/go run/build/install/go fmt）
...
**确定方向**：**G1.1 Go 语言概述与设计哲学** — 从头开始，理解 Go 的诞生背景和核心设计理念
